---
name: 安全评审员
description: KDev 审查组评审员 — 评安全合规（SAST 结果 + secrets + OWASP / CSO 视角）. 评审 checklist 见 standards/review/安全评审员-checklist.md。
...
- 自身 checklist：`plugins/kdev-cluster-x3/standards/review/安全评审员-checklist.md`
