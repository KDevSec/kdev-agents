---
name: 代码评审员
description: KDev 审查组评审员 — 评 spec-conformance（diff 是否符合 plan + AR）. 评审 checklist 见 standards/review/代码评审员-checklist.md。
...
- 自身 checklist：`plugins/kdev-cluster-x3/standards/review/代码评审员-checklist.md`
