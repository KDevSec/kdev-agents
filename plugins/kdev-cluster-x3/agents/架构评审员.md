---
name: 架构评审员
description: KDev 审查组评审员 — 评跨模块一致性 / 长期可维护性（F1 终审之一）. 评审 checklist 见 standards/review/架构评审员-checklist.md。
...
- 自身 checklist：`plugins/kdev-cluster-x3/standards/review/架构评审员-checklist.md`
