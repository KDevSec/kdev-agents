---
name: 测试设计评审员
description: KDev 审查组评审员 — 评测试覆盖度（按 AR 反查）+ 测试设计合理性. 评审 checklist 见 standards/review/测试设计评审员-checklist.md。
...
- 自身 checklist：`plugins/kdev-cluster-x3/standards/review/测试设计评审员-checklist.md`
